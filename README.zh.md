<p align='center'>
<img src='./build/logo.png' width="150" height="150" alt="McpChat AI助手图标" />
</p>

<h1 align="center">McpChat - 强大的开源多模型AI聊天平台</h1>

<p align="center">McpChat是一个功能丰富的开源AI聊天平台，支持多种云端和本地大语言模型，提供强大的搜索增强和工具调用能力。</p>
...
McpChat是一个功能强大的开源AI聊天平台，为用户提供与多种大语言模型交互的统一界面。无论是云端API如OpenAI、Gemini、Anthropic，还是本地部署的Ollama模型，McpChat都能提供流畅的用户体验。

作为一个跨平台的AI助手应用，McpChat不仅支持基础的聊天功能，还提供了搜索增强、工具调用、多模态交互等高级特性，让AI能力的应用更加便捷和高效。

<table align="center">
  <tr>
    <td align="center" style="padding: 10px;">
      <img src='https://github.com/user-attachments/assets/086c4545-6d07-497d-9655-106d00e82ae6' alt="McpChat Light" width="400"/>
      <br/>
    </td>
    <td align="center" style="padding: 10px;">
      <img src='https://github.com/user-attachments/assets/5c3a5e7a-ebe6-4833-8809-9982d8541190' alt="McpChat Dark" width="400"/>
      <br/>
    </td>
  </tr>
</table>
...
从[GitHub Releases](https://github.com/omni-ai-nodes/mcpchat/releases)页面下载适合您系统的最新版本：
...
对于Mac相关的签名和打包，请参考[Mac发布指南](https://github.com/omni-ai-nodes/mcpchat/wiki/Mac-Release-Guide)。
...
McpChat是一个活跃的开源社区项目，我们欢迎各种形式的贡献：

- 🐛 [报告问题](https://github.com/omni-ai-nodes/mcpchat/issues)
- 💡 [提交功能建议](https://github.com/omni-ai-nodes/mcpchat/issues)
- 🔧 [提交代码改进](https://github.com/omni-ai-nodes/mcpchat/pulls)
- 📚 [完善文档](https://github.com/omni-ai-nodes/mcpchat/wiki)
- 🌍 [帮助翻译](https://github.com/omni-ai-nodes/mcpchat/tree/main/locales)
...
<a href="https://github.com/omni-ai-nodes/mcpchat/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=ThinkInAIXYZ/mcpchat" alt="McpChat项目贡献者" />
</a>
