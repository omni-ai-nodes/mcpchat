...
const template = {
  ...
  githubUrl: `https://github.com/omni-ai-nodes/mcpchat/releases/tag/v${params.version}`,
...
platforms.forEach((platform) => {
  ...
  // Start of Selection
  if (os === 'windows') {
    platformData.githubUrl = `https://github.com/omni-ai-nodes/mcpchat/releases/download/v${params.version}/McpChat-${params.version}-windows-${arch}.exe`
  } else if (os === 'mac') {
    platformData.githubUrl = `https://github.com/omni-ai-nodes/mcpchat/releases/download/v${params.version}/McpChat-${params.version}-mac-${arch}.dmg`
  } else if (os === 'linux') {
    platformData.githubUrl = `https://github.com/omni-ai-nodes/mcpchat/releases/download/v${params.version}/McpChat-${params.version}-linux-${arch}.tar.gz`
  }
  // 写入文件
