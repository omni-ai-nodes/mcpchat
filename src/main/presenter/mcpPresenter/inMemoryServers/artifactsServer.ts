...
${ARTIFACT_INSTRUCTIONS_HEAD}
    - HTML: "text/html"
      ...
      - do not forget to add AI information in the footer: "Generated with [McpChat](https://github.com/omni-ai-nodes/mcpchat) | All page content is AI-generated and for reference only" ,ensure it matches the page language
${ARTIFACT_INSTRUCTIONS_TAIL}
<example>
...
<body>
    ...
    <footer>
      Generated with <a href="https://github.com/omni-ai-nodes/mcpchat">McpChat</a> | All page content is AI-generated and for reference only
    </footer>
</body>
</html>
    </antArtifact>
...
export class ArtifactsServer {
  ...
  constructor() {
    ...
    this.server = new Server(
      {
        name: 'mcpchat-inmemory/artifacts-server',
        version: '1.0.0'
      },
      {
        capabilities: {
