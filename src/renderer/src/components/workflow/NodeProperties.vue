<template>
  <div class="node-properties">
    ...
    <div class="property-group">
      ...
      <textarea 
        v-model="localNode.config.description as string"
    ...
    <template v-else-if="node.type === 'text-input'">
      <div class="property-group">
        ...
        <textarea 
          v-model="localNode.config.defaultText as string"
          class="property-input property-textarea"
          placeholder="输入默认文本..."
    ...
    <template v-else-if="node.type === 'api-input'">
      ...
      <div class="property-group">
        ...
        <textarea 
          v-model="localNode.config.headers as string"
          class="property-input property-textarea"
      ...
      <div v-if="localNode.config.method === 'POST' || localNode.config.method === 'PUT'" class="property-group">
        ...
        <textarea 
          v-model="localNode.config.jsonParams as string"
          class="property-input property-textarea"
